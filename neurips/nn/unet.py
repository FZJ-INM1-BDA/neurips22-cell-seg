...
from celldetection.util.util import lookup_nn
...
# def _default_cnvnxt_kwargs(backbone_kwargs, pretrained=False):
#     kw = dict(primary_stride=1, pretrained=pretrained)
#     kw.update({} if backbone_kwargs is None else backbone_kwargs)
#     return kw
#
#
...
#     def __init__(self, in_channels, out_channels, final_activation=None, backbone_kwargs=None, pretrained=False,
#                  block_cls=None, pyr_pool=False, **kwargs):
#         encoder = ConvNeXtTiny(in_channels, **_default_cnvnxt_kwargs(backbone_kwargs, pretrained))
#         if pyr_pool:
#             append_pyr_pool_(encoder, **(pyr_pool if isinstance(pyr_pool, dict) else {}))
#         super().__init__(encoder,
#                          out_channels, final_activation=final_activation, block=block_cls, **kwargs)
...
#     def __init__(self, in_channels, out_channels, final_activation=None, backbone_kwargs=None, pretrained=False,
#                  block_cls=None, pyr_pool=False, **kwargs):
#         encoder = ConvNeXtLarge(in_channels, **_default_cnvnxt_kwargs(backbone_kwargs, pretrained))
#         if pyr_pool:
#             append_pyr_pool_(encoder, **(pyr_pool if isinstance(pyr_pool, dict) else {}))
#         super().__init__(encoder,
#                          out_channels, final_activation=final_activation, block=block_cls, **kwargs)
...
#     def __init__(self, in_channels, out_channels, final_activation=None, backbone_kwargs=None, pretrained=False,
#                  block_cls=None, pyr_pool=False, **kwargs):
#         encoder = ConvNeXtBase(in_channels, **_default_cnvnxt_kwargs(backbone_kwargs, pretrained))
#         if pyr_pool:
#             append_pyr_pool_(encoder, **(pyr_pool if isinstance(pyr_pool, dict) else {}))
#         super().__init__(encoder,
#                          out_channels, final_activation=final_activation, block=block_cls, **kwargs)
...
#     def __init__(self, in_channels, out_channels, final_activation=None, backbone_kwargs=None, pretrained=False,
#                  block_cls=None, pyr_pool=False, **kwargs):
#         encoder = ConvNeXtSmall(in_channels, **_default_cnvnxt_kwargs(backbone_kwargs, pretrained))
#         if pyr_pool:
#             append_pyr_pool_(encoder, **(pyr_pool if isinstance(pyr_pool, dict) else {}))
#         super().__init__(encoder,
#                          out_channels, final_activation=final_activation, block=block_cls, **kwargs)
